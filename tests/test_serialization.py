...
def test_serialize_single_time_series(tmp_path, time_series_in_memory):
    ...
    ts2 = system.get_time_series(
        gen1b, time_series_type=SingleTimeSeries, variable_name=variable_name
    )
...
def test_system_with_single_time_series_normalization(tmp_path, in_memory):
    system = SimpleSystem(
