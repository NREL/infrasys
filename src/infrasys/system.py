...
class System:
    ...
    def get_supplemental_attributes_with_component(
        self,
        component: Component,
        attribute_type: Optional[Type[U]] = None,
        ...
        if attribute_type is not None and attribute_type.__subclasses__():
            msg = (
                "get_supplemental_attributes_with_component does not support attribute_type as "
                "an abstract class"
            )
    ...
    def get_supplemental_attributes(
        self,
        *attribute_types: Type[U],
        filter_func: Optional[Callable[[U], bool]] = None,
    ) -> Generator[Any, None, None]:
        return self._supplemental_attr_mgr.iter(*attribute_types, filter_func=filter_func)
